...
//    c3 = new Computer("Dell", 1700, false);
    ...
    @org.junit.jupiter.api.Test
    void gleicheObjektreferenzenHinzufuegenNichtMoeglich() {
        System.out.println(labor);
        labor.hinzufuegen(c2); // soll nicht moeglich sein, da schon vorhanden
        System.out.println(labor);
        assertEquals(3, labor.anzahlComputer());
    }

    @org.junit.jupiter.api.Test
    void objekteMitGleichemInhaltHinzufuegenNichtMoeglich() {
        System.out.println(labor);
        Computer c = new Computer("Dell", 1700, false);
        labor.hinzufuegen(c); // soll nicht moeglich sein, da schon vorhanden
        System.out.println(labor);
        assertEquals(3, labor.anzahlComputer());
    }
}