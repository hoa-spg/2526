...
class AngestellterTest {
    ...
    void erzeugeAngestelltenMitGueltigemCsvString() {
        ...
        try {
            ...
            assertEquals(1999, a.getGeburtsjahr());
            assertEquals(45, a.getStundenlohn());
            assertEquals(25, a.getAnzahlWochenStunden());
            assertEquals(true, a.hasUeberstundenPauschale());
            System.out.println(a);
